  ...
  <div style="width:100%; height:50rem;">
      ...
      <RadioGroup size="large" type="button" 
        ...
        <Radio :class="{chosenButton: isChosenButton(0)}" 
          ...
          <Button shape="circle"
            ...
            padding: 0 0; margin-top:0.5rem" 
            @click="chosenHub=0; confirmModal=true; user.roomNum=0;">
            <img 
        ...
        width:5rem; padding:0 0;">
          <Button shape="circle"
            style="width:4rem; height:4rem;
            padding: 0 0; margin-top:0.5rem;" 
            @click="chosenHub=1; confirmModal=true; user.roomNum=0;">
            <img 
        ...
        width:5rem; padding:0 0 ;">
          <Button shape="circle"
            ...
            padding: 0 0; margin-top:0.5rem;" 
            @click="chosenHub=2; confirmModal=true; user.roomNum=0;">
            <img 
    ...
    <div style="width:100%; margin-top:1rem; 
      ...
      <Button 
        ...
        font-family:'Perpetua Titling MT','Microsoft Yahei'; font-size: 1.8rem; font-weight:bold;" shape="circle" @click="handleOK">
        OK
        </Button>
    </div>
    ...
    <Modal @on-visible-change="onVisibleChange" v-model="confirmModal" :styles="{top: '16rem', width: '24rem', fontFamily: 'Perpetua Titling MT,Microsoft YaHei'}" :footer-hide="isHideFooter">
      ...
      <div v-if="modalStep==2">
        <input
          ...
          font-family: 'Perpetua Titling MT','Microsoft YaHei'; outline:none;
          text-align:center;" autofocus
          placeholder="CHANNEL CODE" v-model="user.roomNum"
        ></input>
      </div>
      <div 
...
<script>
import {RadioGroup, Radio, Button, Modal, Row, Col, Tooltip,} from 'view-design'
...
export default{
  ...
  components:{
      RadioGroup, Radio, Button, Modal, Row, Col,Tooltip,
  },
  beforeDestroy() {
    //通过总线将数据传递出去
  ...
  data(){
    return{
      ...
      //房间类型
      word:["C","S","T","P","E","L"],
      hoverWords:["Culture","Sports","Technology","Politic","Economy","LifeStyle"]
    }
  },
  computed:{
    //介绍弹窗标题
  ...
  methods:{
    ...
    handleOK(){
      ...
      setCookie("nickName", this.user.nickName, expireDays);
      setCookie("roomNum", this.user.roomNum, expireDays);
      setCookie("avatarNum", this.user.avatarNum, expireDays);
      setCookie("chosenHub", this.user.chosenHub, expireDays);
